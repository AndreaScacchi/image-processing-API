...
var getImage = function (imageName, width, height) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                imagesDirectory = path_1.default.join(__dirname, '../images/thumbs/');
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                outputImages = path_1.default.join(__dirname, '../images/thumbs', "".concat(imageName.toLowerCase(), "(").concat(width, "x").concat(height, ").jpg"));
                _c.label = 1;
            case 1:
                _c.trys.push([1, 3, , 4]);
