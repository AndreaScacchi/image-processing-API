...
describe('Test to find out if the file/image exist', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        rightPath = 'images/santamonica350x350.jpg';
        incorrectPath = 'images/santamonic350x350.jpg';
        it('expecta that file exist', function () { return __awaiter(void 0, void 0, void 0, function () {
            var fileResult;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, checkFile_1.default)(rightPath)];
                    case 1:
                        fileResult = _a.sent();
        ...
        it('expects that file does not exist', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, checkFile_1.default)(incorrectPath)];
                    case 1:
                        fileResult = _a.sent();
...
describe('Test the image process', function () {
    ...
    it('returns the image path', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    filePath = path_1.default.join(__dirname, "../../images/thumbs/", 'santamonica(200x200).jpg');
                    _a = expect;
