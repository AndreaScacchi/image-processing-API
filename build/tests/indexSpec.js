...
describe("Test endpoint responses", function () {
    it("gets the image endpoint", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get("/api/route?imagename=icelandwaterfall&width=300&height=300")];
                case 1:
                    response = _a.sent();
...
describe("test if the resizeImage function works", function () {
    ...
    var outputImages = "/Users/Andrea/Dropbox/PC/Desktop/image-processing-API/images/thumb/icelandwaterfall-300x300.jpg";
    ...
    it("returns a 404 error for incorrect image name", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get("/api/route?imagename=iceland_waterfall&width=300&height=300")];
                case 1:
                    response = _a.sent();
    ...
    it("returns a 404 error for incomplete request", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get("/api/route?imagename=icelandwaterfall&width=300")];
                case 1:
                    response = _a.sent();
                    expect(response.status).toBe(404);
                    return [2 /*return*/];
